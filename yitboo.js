...
function updateContent() {
    if (currentLanguage === 'en') {
        ...
        welcomeDesc.innerHTML = 'YitBoo is the first <strong>online fabric trading platform</strong> in Foshan, Guangdong. It\'s free to use and is dedicated to providing efficient and convenient services for both fabric suppliers and buyers. Our goal is to make it easy for you to find and sell fabrics, fostering mutually beneficial transactions. Additionally, we offer the latest updates and news from the fabric industry, allowing you to stay ahead in this rapidly evolving field.<br><br><strong>Follow us on Facebook: <a href="https://www.facebook.com/profile.php?id=61551196983388">@YitBoo Tech Co., Ltd</a></strong>';
        ...
        contactDesc.innerHTML = 'WhatsApp: +86 156 2277 2205<br><br>Email: business@yitboo.com<br><br>Tel.: +86 0757 8579 8189<br><br>Address: G30, Pingdi Guoji Niuzai Cheng, YanBu Town, Nanhai District, Foshan City, Guangdong Province, China.';
        ...
        contactDesc.innerHTML = '电话：0757-85798189<br>邮箱：business@yitboo.com<br>地址：广东省佛山市南海区盐步平地国际牛仔城G30号';
